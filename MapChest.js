const _DEVICEKeys = new Map([  // Map to check for device keys and assign them description
  ...
  ["IHEAT DETECTOR:HEAT DETECTOR", "Detector Heat"],
  ["MHEAT DETECTOR: HEAT DETECTOR DETECTOR", "Detector Heat"],
  ["MCOH:UTILITY", "Detector Heat/Gas"],
  ["MPHOTO:SMOKE DETECTOR", "Detector Photo Smoke"],
  ["MPHOTO:SMOKE DETECTOR DETECTOR", "Detector Photo Smoke"],
  ...
  ["PHOTO:SMOKE DETECTOR DETECTOR", "Detector Photo Smoke"],
